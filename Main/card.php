...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <h2 align="center">Detail of Each Member</h2>
      <hr>
   <!--    <table border="1" align="center" cellspacing="0" cellpadding="7"> -->
    <br /><table class="container" width="40%" height="20%"  border="2" bordercolor="gray" bgcolor="F4F9F9" cellspacing="0" cellpadding="5">
  <tr>
   <!--  <td align="center" colspan="2">Member Detail</td> -->
   <th>
    <h1>Member Detail</h1>
  </th>
  <th>
  ...
  <tr>
    <td colspan="2" align="center"><a href="navbar.php">Back</a></td>
  </tr>
</table><br /><br />
