  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Reservation Systems</li>
      </ol>
      <h1>All Members List</h1>
      <hr>
      <table border="1" cellspacing="0" cellpadding="2">

      <form action="navbar.php" method="get" target="_self">
Search:
<label for="kw"></label>
<input type="text" name="kw" id="kw" value="<?php echo($kw);?>">
<input type="submit" name="submit" value="OK">
</form></div><br />
<table width="60%" height="20%" border="2" bordercolor="gray" bgcolor="E5E5E5" cellspacing="0" cellpadding="7" align="center">
<tr align="center"><br />
    <td>ID</td>
    <td>Name</td>
...
<?php while($record=mysqli_fetch_array($result)){?>
  ...
  <tr>
    <td><a href="card.php?mid=<?php echo($record[0]);?>"><?php echo($record[0]);?></a></td>
